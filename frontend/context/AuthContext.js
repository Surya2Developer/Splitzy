...
export const AuthProvider = ({ children }) => {
  ...
  const login = async (email, password) => {
    try {
      ...
      // Normalize user
      const normalizedUser = userData?._id ? userData : userData?.id ? { ...userData, _id: userData.id } : userData;
      ...
      // Update API client
      await setAuthTokens({ newAccessToken: access_token, newRefreshToken: refresh_token });
